...
| :------------------------------------------- | :---- | :----------- | :------------------------------------- |
| [KonstBeliakov/asm_to_bf_compiler][as1]      | 2025  | copyrighted  | KonstBeliakov                          |
...
| name                                         | bf  | array  | stack | macro | constexpr | comment | output size |
| :------------------------------------------- | :-- | :----- | :---- | :---- | :-------- | :------ | :---------- |
| [theKidOfArcrania/bf-comp][bf0]              | ?   | no     | ?     | no?   | ?         | ?       | ?           |
| [elikaski/BF-it][bf1]                        | no  | yes    | ?     | yes   | yes       | yes     | medium      |
| [flynow10/bf-transpiler][bf2]                | no  | no     | ?     | no    | yes       | yes     | ?           |
| [benma/bfc][bf4]                             | no  | no     | ?     | yes   | ?         | yes     | medium      |
| [BFC][bf5]                                   | yes | yes    | ?     | yes   | ?         | yes     | medium?     |
| [kkulber/bfcompiler][bf6]                    | ?   | yes    | ?     | ?     | ?         | yes     | ?           |
| [none-None1/BFFuck][bf7]                     | no  | yes    | ?     | yes   | ?         | yes     | ?           |
| [KrokodileGlue/bfm][bf8]                     | no  | yes    | ?     | yes   | yes       | yes     | medium      |
| [felko/bfpy][bf9]                            | no? | no?    | ?     | ?     | ?         | yes     | ?           |
| [nicuveo/BFS][bf10]                          | yes | ?      | ?     | ?     | ?         | yes     | ?           |
| [ImGajeed76/bfscript][bf11]                  | ?   | ?      | ?     | ?     | ?         | yes     | ?           |
| [dqn/bigbrain][bi0]                          | ?   | no     | ?     | no    | ?         | yes     | ?           |
| [jorenheit/brainfix][br1]                    | ?   | yes    | ?     | yes   | ?         | yes     | ?           |
| [ShackledMars261/brainfog][br2]              | yes | ?      | ?     | no    | ?         | yes     | ?           |
| [miggaz_elquez/brainfuck][br3]               | yes | no     | ?     | yes   | ?         | yes     | small?      |
| [vrighter/brainfuck-compiler][br6]           | no  | yes    | ?     | yes   | yes       | yes     | medium      |
| [redcrab2016/Brainfuck-Macro-Assembler][br7] | no  | single | ?     | yes   | ?         | yes     | large       |
| [ImGajeed76/brainfuck_transpiler][br8]       | no  | no     | ?     | no    | ?         | yes     | ?           |
| [FuzzyCat444/BrainUnfuck][br12]              | no  | single | ?     | no    | ?         | yes     | ?           |
| [hsjoihs/camphorscript][ca0]                 | ?   | no?    | ?     | yes   | ?         | yes     | ?           |
| [BliepMonster/CBPP][cb0]                     | ?   | no?    | ?     | yes   | ?         | yes     | ?           |
| [dumkin/ExLang2Bf][ex0]                      | ?   | ?      | ?     | ?     | ?         | ?       | ?           |
| [FBF][fb0]                                   | yes | single | ?     | no    | ?         | yes     | ?           |
| [kmyk/forth-to-brainfuck][fo0]               | yes | ?      | ?     | ?     | ?         | yes     | small?      |
| [VFortier/High-Level-Brainfuck][hi0]         | no? | no?    | ?     | no?   | ?         | yes     | ?           |
| [Heathcorp/Mastermind][ma0]                  | yes | yes    | ?     | yes   | ?         | yes     | ?           |
| [Aarav-g123/python2brainfuck][py0]           | ?   | ?      | ?     | ?     | ?         | yes     | ?           |
| [roodni/reusable-bf][re0]                    | ?   | ?      | ?     | yes   | ?         | yes     | small?      |
| [ZED.CWT/To BrainFuck Transpiler][to0]       | ?   | yes    | ?     | yes   | ?         | yes     | undefined   |
| [bdebowski/brainfuck-transpiler][to0i0]      | ?   | yes    | ?     | yes   | ?         | yes     | ?           |

[as1]: <https://github.com/KonstBeliakov/asm_to_bf_compiler>
