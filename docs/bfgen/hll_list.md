...
| name                                         | inline bf | array  | 2d array | macro | goto | callable | constexpr | comment | output size |
| :------------------------------------------- | :-------- | :----- | :------- | :---- | :--- | :------- | :-------- | :------ | :---------- |
| [YaroslavGaponov/as2bf][as0]                 | ?         | ?      | no       | ?     | yes  | yes      | ?         | yes     | ?           |
| [iczelia/asmbf][as2]                         | yes       | yes    | no       | ?     | yes  | yes      | yes       | yes     | ?           |
| [adam-mcdaniel/basm][ba0]                    | no        | yes    | no       | no    | yes  | yes      | ?         | yes     | ?           |
| [theKidOfArcrania/bf-comp][bf0]              | ?         | no     | no       | no?   | no   | no       | ?         | ?       | ?           |
| [elikaski/BF-it][bf1]                        | no        | yes    | yes      | yes   | no   | no       | yes       | yes     | medium      |
| [flynow10/bf-transpiler][bf2]                | no        | no     | no       | no    | no   | no       | yes       | yes     | ?           |
| [BFASM][bf3]                                 | ?         | single | no       | no?   | yes  | yes      | ?         | yes     | large?      |
| [benma/bfc][bf4]                             | no        | no     | no       | yes   | no   | no       | ?         | yes     | medium      |
| [BFC][bf5]                                   | yes       | yes    | no       | yes   | no   | no       | ?         | yes     | medium?     |
| [kkulber/bfcompiler][bf6]                    | ?         | yes    | no       | ?     | ?    | ?        | ?         | yes     | ?           |
| [none-None1/BFFuck][bf7]                     | no        | yes    | no       | yes   | no   | no       | ?         | yes     | ?           |
| [KrokodileGlue/bfm][bf8]                     | no        | yes    | no       | yes   | no   | no       | yes       | yes     | medium      |
...
| [VilgotanL/Bf-Transpilers/vbf_3][vb0]        | ?         | ?      | ?        | ?     | yes  | no?      | ?         | yes?    | ?           |
